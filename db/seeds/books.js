exports.seed = function(Books(), Promise) {
  function Books(
    return knex('books');
  );
  ...
  Books().insert({
      ...
      books_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/python_in_a_nutshell.jpg'
    }),
    Books().insert({
      title: 'Think Python',
      genre: 'Python',
      description: 'If you want to learn how to program, working with Python is an excellent way to start. This hands-on guide takes you through the language a step at a time, beginning with basic programming concepts before moving on to functions, recursion, data structures, and object-oriented design. This second edition and its supporting code have been updated for Python 3.',
      books_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/think_python.jpg'
    }),
    Books().insert({
      title: 'Learning React Native',
      genre: 'JavaScript',
      description: 'Get a practical introduction to React Native, the JavaScript framework for writing and deploying fully featured mobile apps that look and feel native. With this hands-on guide, you’ll learn how to build applications that target iOS, Android, and other mobile platforms instead of browsers. You’ll also discover how to access platform features such as the camera, user location, and local storage.',
      books_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/learning_react_native.jpg'
    }),
    Books().insert({
      title: 'You Don\'t Know JS',
      genre: 'JavaScript',
      description: 'No matter how much experience you have with JavaScript, odds are you don’t fully understand the language. As part of the ""You Don’t Know JS"" series, this compact guide focuses on new features available in ECMAScript 6 (ES6), the latest version of the standard upon which JavaScript is built.',
      books_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/es6_and_beyond.jpg'
    }),
    Books().insert({
      ...
      books_url: 'http://akamaicovers.oreilly.com/images/0636920032885/lrg.jpg'
    }),
    Books().insert({
      title: 'The Ruby Programming Language',
      genre: 'Ruby',
      description: 'The Ruby Programming Language documents the Ruby language definitively but without the formality of a language specification. It is written for experienced programmers who are new to Ruby, and for current Ruby programmers who want to challenge their understanding and increase their mastery of the language.',
      books_url: 'http://akamaicovers.oreilly.com/images/9780596516178/lrg.jpg'
    }),
    Books().insert({
      ...
      books_url: 'http://akamaicovers.oreilly.com/images/9780596803995/lrg.jpg'
    }),
    Books().insert({
      ...
      books_url: 'http://akamaicovers.oreilly.com/images/0636920033486/lrg.jpg'
    }),
    Books().insert({
      ...
      books_url: 'http://akamaicovers.oreilly.com/images/0636920032977/lrg.jpg'
    }),
    Books().insert({
      title: 'Think Java',
      genre: 'Java',
      ...
      books_url: 'http://akamaicovers.oreilly.com/images/0636920041610/rc_lrg.jpg'
    }),
    Books().insert({
      ...
      books_url: 'http://akamaicovers.oreilly.com/images/0636920032502/lrg.jpg'
    })
};
